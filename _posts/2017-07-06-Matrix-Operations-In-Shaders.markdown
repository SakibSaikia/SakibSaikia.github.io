...
Or alternatively you can use ```#pragma pack_matrix(row_major)``` in HLSL to make the storage match C++. (Thanks to @optimizedaway for pointing this out.)
...
(Thanks to [@rygorous](@rygorous@mastodon.gamedev.place) for the correction related to Terascale. Terascale was VLIW but scalar as well.. Not SIMD!)
