...
If the above constraints are acceptable, this can be a viable technique to using indirect rendering and instancing to optimize CPU time spent in rendering and push more detail. Thanks to [@DrGr4f1x](@DrGr4f1x@mastodon.gamedev.place) for his contribution on this, specially on the culling shaders.
